...
class AppTheme {
  ...
  static TextTheme _buildTextTheme(Color primary, Color secondary) {
    return GoogleFonts.poppinsTextTheme(TextTheme(
      ...
      titleSmall: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: primary, letterSpacing: 0.1),
      ...
      labelMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: secondary, letterSpacing: 0.5),
      labelSmall: TextStyle(fontSize: 11, fontWeight: FontWeight.w500, color: secondary, letterSpacing: 0.5),
    ));
  }
}

// Constant for GoogleFonts Poppins family name — used where explicit fontFamily is needed
final kPoppins = GoogleFonts.poppins().fontFamily!;
