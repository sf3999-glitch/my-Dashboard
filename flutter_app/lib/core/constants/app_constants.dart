class AppConstants {
  ...
  // Supported Currencies (48 currencies)
  static const List<Map<String, dynamic>> supportedCurrencies = [
    ...
    {'code': 'TWD', 'name': 'Taiwan Dollar',         'symbol': 'NT\$','rate': 31.8},
    ...
    {'code': 'BHD', 'name': 'Bahraini Dinar',        'symbol': '.د.ب','rate': 0.377},
    ...
    {'code': 'MAD', 'name': 'Moroccan Dirham',       'symbol': 'MAD', 'rate': 10.1},
    {'code': 'TND', 'name': 'Tunisian Dinar',        'symbol': 'DT',  'rate': 3.12},
    {'code': 'NGN', 'name': 'Nigerian Naira',        'symbol': '₦',   'rate': 1550.0},
    {'code': 'GHS', 'name': 'Ghanaian Cedi',         'symbol': '₵',   'rate': 12.4},
    {'code': 'KES', 'name': 'Kenyan Shilling',       'symbol': 'KSh', 'rate': 132.0},
    {'code': 'ZAR', 'name': 'South African Rand',    'symbol': 'R',   'rate': 18.8},
    {'code': 'ETB', 'name': 'Ethiopian Birr',        'symbol': 'Br',  'rate': 56.0},
    {'code': 'TRY', 'name': 'Turkish Lira',          'symbol': '₺',   'rate': 32.1},
    {'code': 'PLN', 'name': 'Polish Zloty',          'symbol': 'zł',  'rate': 4.02},
    {'code': 'CZK', 'name': 'Czech Koruna',          'symbol': 'Kč',  'rate': 23.5},
    {'code': 'HUF', 'name': 'Hungarian Forint',      'symbol': 'Ft',  'rate': 362.0},
    {'code': 'BRL', 'name': 'Brazilian Real',        'symbol': 'R\$', 'rate': 4.97},
    {'code': 'MXN', 'name': 'Mexican Peso',          'symbol': '\$',  'rate': 17.15},
    {'code': 'ARS', 'name': 'Argentine Peso',        'symbol': '\$',  'rate': 890.0},
    {'code': 'CLP', 'name': 'Chilean Peso',          'symbol': '\$',  'rate': 920.0},
    {'code': 'COP', 'name': 'Colombian Peso',        'symbol': '\$',  'rate': 3950.0},
    {'code': 'PEN', 'name': 'Peruvian Sol',          'symbol': 'S/',  'rate': 3.72},
    {'code': 'RUB', 'name': 'Russian Ruble',         'symbol': '₽',   'rate': 90.5},
    {'code': 'UAH', 'name': 'Ukrainian Hryvnia',     'symbol': '₴',   'rate': 39.0},
    {'code': 'KZT', 'name': 'Kazakhstani Tenge',     'symbol': '₸',   'rate': 450.0},
  ];
